...
salida= "/Users/Alejandro/OneDrive/Escritorio/TFM-2/metricas"
...
metrics <- function(tabla){
  ...
  tabla_xts$Date=NULL # si el xts tiene una sola columna no funciona. Le añado esta para que funcione
