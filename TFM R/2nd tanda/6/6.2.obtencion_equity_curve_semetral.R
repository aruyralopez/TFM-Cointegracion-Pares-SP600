...
salida_output= "/Users/Alejandro/OneDrive/Escritorio/TFM-2/output3"
...
funcion_equity_curve <- function(input, inputd) {
  ...
  for (fila in 2:c(nrow(df))) {  
    df$rent_estrategia[fila] <- case_when(
      #df$year[fila]  == "2005"  ~ (result$Activos_20051_1[fila]+result$Activos_20051_2[fila]+result$Activos_20051_3[fila])/3 ,
      ...
      df$year[fila]  == "2006"  ~ (result$Activos_20061_1[fila]+result$Activos_20061_2[fila]+result$Activos_20061_3[fila])/6 ,
